...
<body>
	...
	<div id="content">
		<div id="content-in">
			...
			<table style="width:980px; height:200px; font-weight: bold; font-size: 38px; text-align: center;">
				<tr>
					<td></td>
					<td>刀刀狗商城账户余额为：<span style="font-size:58px; color:red;"><%=session.getAttribute("sum") %></span></td>
				</tr>
			</table>
			</center>
		</div>
