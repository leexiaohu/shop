		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="/shop/QueryCommodityServlet?id=11">商品历史记录</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-calendar"></i> 商品历史记录</h2>
						<div class="box-icon">
					...
					<div style="height:30px; width:1000px;">
						...
						<div style="width:450px; float:right; margin-top: 10px; ">
							<form action="/shop/QueryCommodityNameServlet" method="post">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-success" href="/shop/QueryCommodityIdServlet?cId=<%=list.get(i).getcId() %>">
					  ...
					  <div class="pagination pagination-centered">
						  <ul>
							...
							<%for(int i=1;i<((listsize/10)+2);i++){ %>
								<li><a href="/shop/QueryCommodityFServlet?num=<%=i %>">[<%=i %>]</a></li>
							<%} %>
