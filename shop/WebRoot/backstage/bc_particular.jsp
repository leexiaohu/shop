		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="/shop/QueryCommodityServlet?id=15">商品历史记录</a><span class="divider">/</span>
					</li>
					<li>
						<a href="#">商品详细</a>
					</li>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-calendar"></i> 商品详细</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable"  valign="top">
						  ...
						  <%
						  		...
						  		for(int i=0;i<list.size();i++){
						  			String str = sdf.format(list.get(i).getcODate());
						   %>
							 <tr>
								 <th style="width: 150px;">商品编号</th>
								  <td class="center"><%=list.get(i).getcNum() %></td>
							 </tr>
							...
							<tr>
								  <th>商品规格</th>
								  <td class="center"><%=list.get(i).getcFormat() %></td>
							</tr>
							 <tr>
								  <th>商品单价</th>
							 ...
							 <tr>
								  <th>商品描述</th>
								  <td class="center"><%=list.get(i).getcContent() %></td>
							  </tr>
							  <tr>
								  <th>进货时间</th>
								  <td class="center"><%=list.get(i).getcIDate() %></td>
							  </tr>
							 <%if(str.equals("05/25/1992")){%>
							  <tr>
								  <th>销货时间</th>
								  <td class="center"><span>无</span></td>
							  </tr>
							  <%}else{ %>
							   <tr>
								  <th>销货时间</th>
								  <td class="center"><%=list.get(i).getcODate() %></td>
							  </tr>
							  <%} %>
							  <tr>
								  <th>商品图片</th>
							  ...
							  <tr>	  
								  <td class="center" colspan="2"><img alt="Dao dao dog" src="<%=list.get(i).getcImg() %>" width="500px"/></td>
							  </tr>
							  <%} %>
						  </thead>   
