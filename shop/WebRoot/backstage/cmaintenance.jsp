		...
		<div class="row-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="index.jsp"><i class="icon-home"></i><span class="hidden-tablet"> 主界面</span></a></li>
						...
						<li><a class="ajax-link" href="table.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> 用户维护</span></a></li>
						...
						<li><a class="ajax-link" href="cmaintenance.jsp"><i class="icon-calendar"></i><span class="hidden-tablet"> 商品添加</span></a></li>
						<li><a class="ajax-link" href="cmaintenance.jsp"><i class="icon-calendar"></i><span class="hidden-tablet"> 商品修改</span></a></li>
						<li><a class="ajax-link" href="cmaintenance.jsp"><i class="icon-calendar"></i><span class="hidden-tablet"> 商品删除</span></a></li>
					</ul>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="cmaintenance.jsp">商品维护</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i> 商品展示</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<p class="center">
							<button id="toggle-fullscreen" class="btn btn-large btn-primary visible-desktop" data-toggle="button">全屏展示</button>
						</p>
						<br/>
						<ul class="thumbnails gallery">
														<li id="image-1" class="thumbnail">
								<a style="background:url(img/goods/b1.jpg)" title="Sample Image 1" href="img/1.jpg"><img class="grayscale" src="img/1.jpg" alt="Sample Image 1"></a>
							</li>
