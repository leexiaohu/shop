		...
		<div class="row-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="/shop/QueryCommodityServlet?id=15"><i class="icon-calendar"></i><span class="hidden-tablet"> 商品维护</span></a></li>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="/shop/backstage/index.jsp">主界面</a>
					</li>
				</ul>
			</div>
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>主面板</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<img alt="Dao dao dog" src="../upload/1.jpg" width="1000px"/>
					</div>
				</div>
				<!-- content ends -->
			</div><!--/#content.span10-->
