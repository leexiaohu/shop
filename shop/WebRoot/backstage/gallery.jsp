				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<ul class="thumbnails gallery">
								...
								<a style="background:url(img/goods/2.jpg);width:100px; height:100px;" title="Sample Image 1" href="img/1.jpg"><img class="grayscale" src="img/1.jpg" alt="Sample Image 1"></a>
							</li>
