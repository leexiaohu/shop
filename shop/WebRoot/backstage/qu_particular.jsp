		...
		<div class="row-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="/shop/QUServlet?id=21"><i class="icon-align-justify"></i><span class="hidden-tablet"> 用户查看</span></a></li>
						<li><a class="ajax-link" href="/shop/QUServlet?id=23"><i class="icon-align-justify"></i><span class="hidden-tablet"> 用户修改</span></a></li>
						<li><a class="ajax-link" href="/shop/QUServlet?id=24"><i class="icon-align-justify"></i><span class="hidden-tablet"> 用户删除</span></a></li>
					</ul>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="/shop/QUServlet?id=21">用户查看</a><span class="divider">/</span>
					</li>
					<li>
						<a href="#">用户详细</a>
					</li>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-align-justify"></i> 用户详细</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable"  valign="top">
						  <thead>
						  <%
						   ...
						   %>
							 <tr>
								 <th style="width: 150px;">用户编号</th>
								  <td class="center"><%=list.get(0).getuId() %></td>
							 </tr>
							 
							 <tr>
								  <th>用户名称</th>
								  <td class="center"><%=list.get(0).getuName() %></td>
							</tr>
							<tr>
								  <th>密码</th>
								  <td class="center"><%=list.get(0).getuPsw() %></td>
							</tr>
							 <tr>
								  <th>账号</th>
								  <td class="center"><%=list.get(0).getuNum() %></td>
							</tr>
							
							 <tr>
								  <th>真实姓名</th>
								  <td class="center"><%=list.get(0).getuRName() %></td>
							</tr>
							 <tr>
								  <th>电话</th>
								  <td class="center"><%=list.get(0).getuTel() %></td>
							</tr>
							 <tr>
								  <th>地址</th>
								  <td class="center"><%=list.get(0).getuAdd() %></td>
							</tr>
							<tr>
								  <th>Email</th>
								  <td class="center"><%=list.get(0).getuEmail() %></td>
							</tr>
							<%if(list.get(0).getuStatus() == 1){ %>
							<tr>
								<th>状态</th>
						  		<td>可用</td>
						  	</tr>
